                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="<?php echo htmlspecialchars(rtrim(dirname($_SERVER['SCRIPT_NAME']), '/').'/review_periods'); ?>">
                    Manage Review Periods
                      ...
                      <a class="dropdown-item" href="<?php echo htmlspecialchars(rtrim(dirname($_SERVER['SCRIPT_NAME']), '/').'/performance_reviews/initiate_form'); ?>">
                        Initiate Reviews
                      </a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="<?php echo htmlspecialchars(rtrim(dirname($_SERVER['SCRIPT_NAME']), '/').'/performance_reviews/my_pending_reviews'); ?>">
                        My Pending Self-Assessments
                      </a>
                      <a class="dropdown-item" href="<?php echo htmlspecialchars(rtrim(dirname($_SERVER['SCRIPT_NAME']), '/').'/performance_reviews/team_reviews_pending_manager'); ?>">
                        Team Reviews Pending Input
                      </a>
                  <!-- Other performance related links later -->
                </div>
              </li>
              <!-- NEW RECRUITMENT DROPDOWN -->
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#navbar-recruitment" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users-plus" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4c.96 0 1.84 .183 2.633 .512m3.099 1.751a3.999 3.999 0 0 1 -2.732 2.737" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M16 19h6" /><path d="M19 16v6" /></svg>
                  </span>
                  <span class="nav-link-title">
                    Recruitment
                  </span>
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="<?php echo htmlspecialchars(rtrim(dirname($_SERVER['SCRIPT_NAME']), '/').'/job_postings'); ?>">
                    Manage Job Postings
                  </a>
                  <!-- Other recruitment links later -->
                </div>
              </li>
